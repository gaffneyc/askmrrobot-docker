...
LABEL description="AskMrRobot Simulator v1519 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1519.zip && \
  unzip -d / client.zip && \
  rm client.zip
