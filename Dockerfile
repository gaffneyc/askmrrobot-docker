...
LABEL description="AskMrRobot Simulator v1569 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1569.zip && \
  unzip -d / client.zip && \
  rm client.zip
