...
LABEL description="AskMrRobot Simulator v1616 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1616.zip && \
  unzip -d / client.zip && \
  rm client.zip
