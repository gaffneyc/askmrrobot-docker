...
LABEL description="AskMrRobot Simulator v1174 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static2.askmrrobot.com/wowsite/client/AskMrRobotClient-any-1174.zip && \
  unzip -d / client.zip && \
  rm client.zip
