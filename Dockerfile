...
LABEL description="AskMrRobot Simulator v1570 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1570.zip && \
  unzip -d / client.zip && \
  rm client.zip
