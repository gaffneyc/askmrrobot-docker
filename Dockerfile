...
LABEL description="AskMrRobot Simulator v1592 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1592.zip && \
  unzip -d / client.zip && \
  rm client.zip
