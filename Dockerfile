...
LABEL description="AskMrRobot Simulator v1223 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static2.askmrrobot.com/wowsite/client/AskMrRobotClient-any-1223.zip && \
  unzip -d / client.zip && \
  rm client.zip
