...
LABEL description="AskMrRobot Simulator v1632 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1632.zip && \
  unzip -d / client.zip && \
  rm client.zip
