...
LABEL description="AskMrRobot Simulator v1216 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static2.askmrrobot.com/wowsite/client/AskMrRobotClient-any-1216.zip && \
  unzip -d / client.zip && \
  rm client.zip
