...
LABEL description="AskMrRobot Simulator v1522 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1522.zip && \
  unzip -d / client.zip && \
  rm client.zip
