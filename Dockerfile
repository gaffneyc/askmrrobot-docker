...
LABEL description="AskMrRobot Simulator v1612 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1612.zip && \
  unzip -d / client.zip && \
  rm client.zip
