...
LABEL description="AskMrRobot Simulator v1583 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1583.zip && \
  unzip -d / client.zip && \
  rm client.zip
