...
LABEL description="AskMrRobot Simulator v1546 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static.askmrrobot.com/wowsite/client/AskMrRobotClient-universal-1546.zip && \
  unzip -d / client.zip && \
  rm client.zip
