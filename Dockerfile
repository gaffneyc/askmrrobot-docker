...
LABEL description="AskMrRobot Simulator v1144 - https://www.askmrrobot.com/wow/simulator/client"
...
RUN \
  wget -q -O client.zip https://static2.askmrrobot.com/wowsite/client/AskMrRobotClient-any-1144.zip && \
  unzip -d / client.zip && \
  rm client.zip
